      ...
      display = results.map((result) => {
        switch (result.category) {
          case 'people': {
            ...
            return (
              <div className="one-card" key={name}>
                <img src="images/people.png" className="card-image" alt="people" />
                <ul>
                  <li><b>{name}</b></li>
          ...
          case 'planets': {
            ...
            return (
              <div className="one-card" key={name}>
                <img src="images/planet.png" className="card-image" alt="planet" />
                <ul>
                  <li><b>{name}</b></li>
                  <li>category: {category}</li>
          ...
          case 'species': {
            ...
            return (
              <div className="one-card" key={name}>
                <img src="images/species.png" className="card-image" alt="species" />
                <ul>
                  <li><b>{name}</b></li>
                  <li>category: {category}</li>
          ...
          case 'vehicles': {
            ...
            const image = (result.category === 'vehicles') ?
              <img src="images/vehicle.png" className="card-image" alt="vehicle" /> :
              <img src="images/starship.png" className="card-image" alt="starship" />;
            return (
              <div className="one-card" key={name}>
                {image}
                <ul>
